...
fn success_restart_game() {
    ...
    // start game
    system.mint_to(ADMIN, 99999999999999999);
...
fn success_giveup() {
    ...
    system.init_logger();
    let game = Program::current(&system);
    system.mint_to(ADMIN, 22222222222211111111);
    game.send(
        ADMIN,
        PebblesInit {
            difficulty: DIFFICULTY_EASY,
...
fn success_run_game_with_difficulty_easy() {
    ...
    system.init_logger();
    let game = Program::current(&system);
    system.mint_to(ADMIN, 46545445644646464646);
    game.send(
        ADMIN,
        PebblesInit {
            difficulty: DIFFICULTY_EASY,
...
fn success_run_game_with_difficulty_hard() {
    ...
    system.mint_to(ADMIN, 9888888878788789778);
